...
import com.watabou.undegradedpixeldungeon.Rankings;
...
import com.watabou.undegradedpixeldungeon.windows.WndError;
import com.watabou.undegradedpixeldungeon.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			title.hardlight( Window.UNDEGRADED_COLOR );
			title.measure();
			...
			if (Rankings.INSTANCE.totalNumber >= Rankings.TABLE_SIZE) {
				...
				won.hardlight( Window.UNDEGRADED_COLOR );
				won.measure();
				add( won );
